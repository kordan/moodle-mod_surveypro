...
switch ($moduletab) {
    case SURVEYPRO_TABITEMS:
        ...
        if ($canmanageitems) {
            ...
            if (empty($surveypro->template)) {
                // Setup.
                if ($modulepage == SURVEYPRO_ITEMS_SETUP) {
    ...
    case SURVEYPRO_TABSUBMISSIONS:
        ...
        // Edit.
        if ($modulepage == SURVEYPRO_SUBMISSION_EDIT) {
        ...
        // Report.
        if ($modulepage == SURVEYPRO_SUBMISSION_REPORT) {
            if ($canaccessreports) {
        ...
        if ($modulepage == SURVEYPRO_SUBMISSION_IMPORT) {
            // Import.
            if ($canimportdata) {
        ...
        if ($modulepage == SURVEYPRO_SUBMISSION_EXPORT) {
            // Export.
            if ($canexportdata) {
