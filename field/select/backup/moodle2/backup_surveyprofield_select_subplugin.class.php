...
/**
 * This file contains the backup code for the surveyprofield_select plugin.
 *
...
class backup_surveyprofield_select_subplugin extends backup_subplugin {
    ...
    protected function define_item_subplugin_structure() {
        ...
        // Define sources.
        $subpluginselect->set_source_table('surveyprofield_select', ['itemid' => backup::VAR_PARENTID]);
