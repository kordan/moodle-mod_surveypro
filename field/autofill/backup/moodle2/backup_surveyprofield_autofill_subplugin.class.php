...
class backup_surveyprofield_autofill_subplugin extends backup_subplugin {
    ...
    protected function define_item_subplugin_structure() {
        ...
        $subpluginautofills = new backup_nested_element($this->get_recommended_name());
        ...
        $subplugin->add_child($subpluginautofills);
        $subpluginautofills->add_child($subpluginautofill);
