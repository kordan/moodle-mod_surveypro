...
/**
 * This file contains the restore code for the surveyprofield_rate plugin.
 *
 ...
 * to restore one surveyprofield_rate subplugin.
 *
 * @package   surveyprofield_rate
 * @copyright 2010 onwards Eloy Lafuente (stronk7) {@link http://stronk7.com}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class restore_surveyprofield_rate_subplugin extends restore_subplugin {
     ...
     * @param mixed $data
     */
    public function process_surveyprofield_rate($data) {
        global $DB;
