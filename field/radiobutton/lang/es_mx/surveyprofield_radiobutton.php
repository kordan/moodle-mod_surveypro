...
$string['adjustment_help'] = '¿Cóomo se mostrará esta lista? ¿En horizontal o en vertical?';
...
$string['ierr_missingdefault'] = 'Falta el valor por defecto personalizado. Usted podría desear elegir el de  "{$a}".';
...
$string['userfriendlypluginname'] = 'Botones de selección';
