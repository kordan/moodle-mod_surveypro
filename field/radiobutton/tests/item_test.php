...
/**
 * Unit tests for surveyprofield_radiobutton item
 *
...
/**
 * Unit tests for surveyprofield_radiobutton\item methods.
 */
#[\PHPUnit\Framework\Attributes\CoversClass(\surveyprofield_radiobutton\item::class)]
final class item_test extends \advanced_testcase {
    ...
    /**
     * Instantiate surveyprofield_radiobutton\item with minimal dependencies.
     *
    ...
    public function test_get_multilang_fields_has_expected_keys(): void {
        ...
        $this->assertArrayHasKey('surveyprofield_radiobutton', $result);
    }
    ...
    public function test_get_multilang_fields_plugin_fields(): void {
        ...
        $this->assertContains('options', $result['surveyprofield_radiobutton']);
        $this->assertContains('labelother', $result['surveyprofield_radiobutton']);
        $this->assertContains('defaultvalue', $result['surveyprofield_radiobutton']);
    }
    ...
    /**
     * Encoding two valid options on separate lines must return only the first index
     * (radiobutton allows only one selection — duplicates are removed by array_unique).
     */
    ...
    /**
     * Encoding an empty string must return an empty string since no options are selected
     * and no garbage is present.
     */
    ...
    public function test_parent_encode_mixed_valid_and_garbage(): void {
        ...
        $this->assertContains('0', $parts);   // index of 'first'.
