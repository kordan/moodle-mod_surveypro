...
Feature: Search using one and two radiobutton items
  In order to validate search form with one and two items
  As a student
  I search for submitted records.

  @javascript
  Scenario: Search using one and two radiobutton fields
    Given the following "courses" exist:
      | fullname                     | shortname   | category | numsections |
      | Test radiobutton search form | Search form | 0        | 1           |
    ...
    And I set the following fields to these values:
      | id_field_radiobutton_1_0 | 1 |
      | id_field_radiobutton_2_3 | 1 |
    And I press "Submit"

    # 1st search for submitted records
    Given I am on the "Radio button search form test" "surveypro activity" page logged in as student1
    ...
    And I set the field "id_field_radiobutton_2_3" to "1"
    And I press "Search"
