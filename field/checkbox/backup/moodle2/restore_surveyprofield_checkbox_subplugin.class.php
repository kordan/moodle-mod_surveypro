...
/**
 * This file contains the restore code for the surveyprofield_checkbox plugin.
 *
 ...
 * to restore one surveyprofield_checkbox subplugin.
 *
 * @package   surveyprofield_checkbox
 * @copyright 2010 onwards Eloy Lafuente (stronk7) {@link http://stronk7.com}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class restore_surveyprofield_checkbox_subplugin extends restore_subplugin {
     ...
     * @param mixed $data
     */
    public function process_surveyprofield_checkbox($data) {
        global $DB;
