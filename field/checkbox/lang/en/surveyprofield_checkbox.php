...
/**
 * Strings for component 'surveyprofield_checkbox', language 'en', branch 'MOODLE_31_STABLE'
 *
...
$string['ierr_optionduplicated'] = 'Defaults must be unique';
$string['ierr_optionsduplicated'] = 'Options must be unique';
