...
$string['defaultoption_help'] = 'Este es el número entero que el usuario remoto encontrará contestado por defecto. El valor por defecto para este tipo de pregunta es obligatorio.';
...
$string['lowerbound_help'] = 'El menor número entero que se le permite ingresr al usuario';
$string['maximuminteger'] = 'Número entero máximo';
$string['maximuminteger_desc'] = 'El máximo número entero que este software permitirá ingresar';
$string['parentformat'] = '[un número entero]';
$string['pluginname'] = 'número entero';
...
$string['uerr_integernotset'] = 'Por favor elija un valor o el último ítem: "{$a}"';
$string['uerr_integernotsetrequired'] = 'Por favor elija un valor';
...
$string['upperbound_help'] = 'El mayor número entero que el usuario tiene permitido ingresar';
$string['userfriendlypluginname'] = 'Número entero (pequeño)';
