...
function xmldb_surveyprofield_date_upgrade($oldversion) {
    ...
    if ($oldversion < 2024022701) {
        ...
        // Date savepoint reached.
        upgrade_plugin_savepoint(true, 2024022701, 'surveyprofield', 'date');
    }
    ...
    if ($oldversion < 2024032800) {
        ...
        // Date savepoint reached.
        upgrade_plugin_savepoint(true, 2024032800, 'surveyprofield', 'date');
    }
