...
function xmldb_surveyprofield_datetime_upgrade($oldversion) {
    ...
    if ($oldversion < 2024022701) {
        ...
        if ($condition) {
            $sql = 'UPDATE {surveypro_item} i
                    JOIN {surveyprofield_datetime} f ON f.itemid = i.id
        ...
        // Datetime savepoint reached.
        upgrade_plugin_savepoint(true, 2024022701, 'surveyprofield', 'datetime');
    }
    ...
    if ($oldversion < 2024032800) {
        ...
        // Datetime savepoint reached.
        upgrade_plugin_savepoint(true, 2024032800, 'surveyprofield', 'datetime');
    }
