...
Feature: Search using one and two boolean items
  In order to validate search form with one and two items
  As a student
  I search for submitted records.

  @javascript
  Scenario: Search using one and two boolean fields
    Given the following "courses" exist:
      | fullname                 | shortname   | category | numsections |
      | Test boolean search form | Search form | 0        | 1           |
    ...
    And I set the field "id_field_boolean_1_1" to "1"
    And I set the field "id_field_boolean_2_0" to "1"
    And I press "Submit"

    # Add the second record
    And I press "New response"
    And I set the field "id_field_boolean_1_1" to "1"
    And I set the field "id_field_boolean_2_1" to "1"
    And I press "Submit"

    # 1st search for submitted records
    Given I am on the "Boolean search form test" "surveypro activity" page logged in as student1
