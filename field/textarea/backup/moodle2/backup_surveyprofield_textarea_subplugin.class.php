...
class backup_surveyprofield_textarea_subplugin extends backup_subplugin {
    ...
    protected function define_item_subplugin_structure() {
        ...
        $subplugintextarea = new backup_nested_element('surveyprofield_textarea', ['id'], [
            'trimonsave', 'useeditor', 'arearows', 'areacols', 'minlength', 'maxlength',
        ]);
        ...
        // Define sources.
        $subplugintextarea->set_source_table('surveyprofield_textarea', ['itemid' => backup::VAR_PARENTID]);
