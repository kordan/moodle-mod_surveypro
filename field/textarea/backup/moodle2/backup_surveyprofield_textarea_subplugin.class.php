...
class backup_surveyprofield_textarea_subplugin extends backup_subplugin {
    ...
    protected function define_item_subplugin_structure() {
        ...
        $subplugintextareas = new backup_nested_element($this->get_recommended_name());
        ...
        $subplugin->add_child($subplugintextareas);
        $subplugintextareas->add_child($subplugintextarea);
