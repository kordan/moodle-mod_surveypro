...
$string['restrictions_maximumrequired_more'] = 'No more than {$a} options are allowed';
$string['restrictions_maximumrequired_one'] = 'No more than 1 option is allowed';
$string['restrictions_minimumrequired_more'] = 'At least {$a} options have to be selected';
$string['restrictions_minimumrequired_one'] = 'At least 1 option has to be selected';
