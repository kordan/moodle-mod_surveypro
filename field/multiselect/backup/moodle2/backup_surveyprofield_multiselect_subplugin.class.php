...
/**
 * This file contains the backup code for the surveyprofield_multiselect plugin.
 *
...
class backup_surveyprofield_multiselect_subplugin extends backup_subplugin {
    ...
    protected function define_item_subplugin_structure() {
        ...
        $subpluginmultiselect = new backup_nested_element('surveyprofield_multiselect', ['id'], array(
        ...
        // Define sources.
        $subpluginmultiselect->set_source_table('surveyprofield_multiselect', ['itemid' => backup::VAR_PARENTID]);
