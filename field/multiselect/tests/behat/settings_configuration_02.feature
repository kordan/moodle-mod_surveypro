...
Feature: Validate creation and submit for "multiselect" elements using the principal combinations of settings (2 of 4)
  ...
  @javascript
  Scenario: test multiselect element using configuration 03
  ...
  @javascript
  Scenario: test multiselect element using configuration 04
