...
function xmldb_surveyprofield_fileupload_upgrade($oldversion) {
    ...
    if ($oldversion < 2024022701) {
        ...
        if ($condition) {
            $sql = 'UPDATE {surveypro_item} i
                    JOIN {surveyprofield_fileupload} f ON f.itemid = i.id
        ...
        // Fileupload savepoint reached.
        upgrade_plugin_savepoint(true, 2024022701, 'surveyprofield', 'fileupload');
    }
    ...
    if ($oldversion < 2024032800) {
        ...
        // Fileupload savepoint reached.
        upgrade_plugin_savepoint(true, 2024032800, 'surveyprofield', 'fileupload');
    }
