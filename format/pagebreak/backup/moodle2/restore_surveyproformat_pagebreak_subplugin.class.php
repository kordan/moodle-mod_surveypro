...
/**
 * This file contains the restore code for the surveyproformat_pagebreak plugin.
 *
 ...
 * to restore one surveyproformat_pagebreak subplugin.
 *
 * @package   surveyproformat_pagebreak
 * @copyright 2010 onwards Eloy Lafuente (stronk7) {@link http://stronk7.com}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class restore_surveyproformat_pagebreak_subplugin extends restore_subplugin {
     ...
     * @param mixed $data
     */
    public function process_surveyproformat_pagebreak($data) {
        global $DB;
