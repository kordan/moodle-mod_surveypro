...
class mod_surveypro_renderer extends plugin_renderer_base {
    ...
    public function import_setting_mappings($datamodule, data_preset_importer $importer) {
        ...
        $manager = \mod_surveypro\manager::create_from_coursemodule($datamodule);
     ...
     *
     * @param stdClass $datamodule  Database module to import to.
     * @param \mod_surveypro\local\importer\preset_importer $importer Importer instance to use for the importing.
     *
     * @return string
     */
    public function importing_preset(stdClass $datamodule, \mod_surveypro\local\importer\preset_importer $importer): string {
     ...
     *
     * @param \mod_surveypro\output\fields_action_bar $actionbar
     * @return string The HTML output
     */
    public function render_fields_action_bar(\mod_surveypro\output\fields_action_bar $actionbar): string {
        $data = $actionbar->export_for_template($this);
        $data['title'] = get_string('nofields', 'mod_surveypro');
        $data['intro'] = get_string('createfields', 'mod_surveypro');
        $data['noitemsimgurl'] = $this->output->image_url('fields_zero_state', 'mod_surveypro')->out();
        return $this->render_from_template('mod_surveypro/fields_action_bar', $data);
    }
    ...
    public function render_fields_footer(manager $manager): string {
        ...
        $pageurl = new moodle_url('/mod/surveypro/templates.php', ['id' => $cm->id]);
        return $this->render_from_template('mod_surveypro/fields_footer', [
     ...
     *
     * @param \mod_surveypro\output\templates_action_bar $actionbar
     * @return string The HTML output
     */
    public function render_templates_action_bar(\mod_surveypro\output\templates_action_bar $actionbar): string {
        $data = $actionbar->export_for_template($this);
        return $this->render_from_template('mod_surveypro/templates_action_bar', $data);
    }

    /**
     * Renders the action bar for the preset page.
     *
     * @param \mod_surveypro\output\presets_action_bar $actionbar
     * @return string The HTML output
     */
    public function render_presets_action_bar(\mod_surveypro\output\presets_action_bar $actionbar): string {
        $data = $presets->export_for_template($this);
        return $this->render_from_template('mod_surveypro/presets', $data);
    }

    /**
     * Renders the default template.
     *
     * @param \mod_surveypro\output\defaulttemplate $template
     * @return string The HTML output
     */
    public function render_defaulttemplate(\mod_surveypro\output\defaulttemplate $template): string {
     ...
     *
     * @param \mod_surveypro\manager $manager The manager instance.
     *
     * @return string The HTML output
     */
    public function render_database_zero_state(\mod_surveypro\manager $manager): string {
        $actionbar = new \mod_surveypro\output\zero_state_action_bar($manager);
        $data = $actionbar->export_for_template($this);
        if (empty($data)) {
            // No actions for the user.
            $data['title'] = get_string('activitynotready');
            $data['intro'] = get_string('comebacklater');
            $data['noitemsimgurl'] = $this->output->image_url('noentries_zero_state', 'mod_surveypro')->out();
        } else {
            $data['title'] = get_string('startbuilding', 'mod_surveypro');
            $data['intro'] = get_string('createactivity', 'mod_surveypro');
            $data['noitemsimgurl'] = $this->output->image_url('view_zero_state', 'mod_surveypro')->out();
        }

        return $this->render_from_template('mod_surveypro/zero_state', $data);
    }
     ...
     * @return string The HTML output
     */
    public function render_empty_database(\mod_surveypro\manager $manager): string {
        $actionbar = new \mod_surveypro\output\empty_database_action_bar($manager);
        $data = $actionbar->export_for_template($this);
        $data['noitemsimgurl'] = $this->output->image_url('view_zero_state', 'mod_surveypro')->out();

        return $this->render_from_template('mod_surveypro/view_noentries', $data);
    }
     ...
     * @return string The HTML output
     */
    public function render_fields_zero_state(\mod_surveypro\manager $manager): string {
        $data = [
            'noitemsimgurl' => $this->output->image_url('fields_zero_state', 'mod_surveypro')->out(),
            'title' => get_string('nofields', 'mod_surveypro'),
            'intro' => get_string('createfields', 'mod_surveypro'),
            ];
        if ($manager->can_manage_templates()) {
            $actionbar = new \mod_surveypro\output\action_bar($manager->get_instance()->id, $this->page->url);
     ...
     * @return string The HTML output
     */
    public function render_templates_zero_state(\mod_surveypro\manager $manager): string {
        $actionbar = new \mod_surveypro\output\zero_state_action_bar($manager);
        $data = $actionbar->export_for_template($this);
        $data['title'] = get_string('nopresets', 'mod_surveypro');
        $data['intro'] = get_string('createpresets', 'mod_surveypro');
        $data['noitemsimgurl'] = $this->output->image_url('presets_zero_state', 'mod_surveypro')->out();
