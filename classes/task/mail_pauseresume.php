...
class mail_pauseresume extends \core\task\scheduled_task {
    ...
    public function execute() {
        ...
        $where = ['pauseresume' => SURVEYPRO_PAUSERESUMEEMAIL];
        if ($surveypros = $DB->get_records('surveypro', $where, 'course', 'id, name, keepinprogress')) {
            ...
            // BUT you are supposed to submit your survey in $maxinputdelay hours.
