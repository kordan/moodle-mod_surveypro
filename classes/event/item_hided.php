...
/**
 * The mod_surveypro all items hided event class.
 *
 * @package   mod_surveypro
 * @copyright 2013 onwards kordan <kordan@mclink.it>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class item_hided extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_item_hided', 'mod_surveypro');
    }
    ...
    public function get_description() {
        return "User with id '{$this->userid}' hided the '{$this->other['plugin']}' item with id '{$this->objectid}.";
    }
    ...
    public function get_legacy_logdata() {
        ...
        return array($this->courseid, 'surveypro', 'item hided',
