...
class all_submissions_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_all_submissions_deleted', 'mod_surveypro');
    }
    ...
    public function get_description() {
        return "User with id '{$this->userid}' deleted all the submissions.";
    }
    ...
    public function get_legacy_logdata() {
        ...
        return array($this->courseid, 'surveypro', 'all submissions deleted',
