...
class all_submissions_exported extends \core\event\base {
    ...
    protected function init() {
        ...
        $this->data[SURVEYPRO_EVENTLEVEL] = self::LEVEL_TEACHING;
    ...
    public function get_description() {
        return "User {$this->userid} has exported all the submissions.";
    }
    ...
    public function get_url() {
        return new \moodle_url('view_export.php', array('id' => $this->contextinstanceid));
    }
