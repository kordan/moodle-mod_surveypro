...
class usertemplate_applied extends \core\event\base {
    ...
    public function get_description() {
        return "User {$this->userid} has applied the user template {$this->other['templatename']}.";
    }
    ...
    public function get_url() {
        return new \moodle_url('utemplates_apply.php', array('id' => $this->contextinstanceid));
    }
