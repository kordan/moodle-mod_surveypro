...
$string['tabsubmissionsname'] = 'Questionario';
    $string['tabsubmissionspage1'] = 'Pannello di controllo';
    $string['tabsubmissionspage2'] = 'Inserimento';
    $string['tabsubmissionspage3'] = 'Dati inseriti';
