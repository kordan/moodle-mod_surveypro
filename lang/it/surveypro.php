...
$string['event_all_submissions_exported'] = 'Tutte le risposte sono state esportate';
$string['event_all_submissions_viewed'] = 'Tutte le risposte sono state visualizzate';
$string['event_all_usertemplates_viewed'] = 'Tutti i "template utente" sono state visualizzati';
$string['event_form_previewed'] = 'L\'anteprima del survey è stata visualizzata';
$string['event_item_created'] = 'Un item è stato creato';
$string['event_item_deleted'] = 'Un item è stato cancellato';
$string['event_item_hidden'] = 'Un item è stato nascosto alla vista';
$string['event_item_modified'] = 'Un item è stato modificato';
$string['event_item_shown'] = 'Un item è stato reso visibile';
$string['event_mastertemplate_applied'] = 'Un "template di sistema" è stato applicato';
$string['event_mastertemplate_saved'] = 'Un "template di sistema" è stato salvato';
$string['event_submission_created'] = 'Una nuova risposta è stata inviata';
$string['event_submission_deleted'] = 'Una risposta è stata cancellata';
$string['event_submission_modified'] = 'Una risposta è stata modificata';
$string['event_submission_viewed'] = 'Una risposta è stata visualizzata';
$string['event_submissioninpdf_downloaded'] = 'Una risposta è stata scaricata in pdf';
$string['event_submissions_imported'] = 'Risposte importate';
$string['event_usertemplate_applied'] = 'Un "template utente" è stato applicato';
$string['event_usertemplate_deleted'] = 'Un "template utente" è stato cancellato';
$string['event_usertemplate_exported'] = 'Un "template utente" è stato esportato';
$string['event_usertemplate_imported'] = 'Un "template utente" è stato importato';
$string['event_usertemplate_saved'] = 'Un "template utente" è stato salvato';
