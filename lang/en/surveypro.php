...
$string['af_allitems_deleted'] = 'All the elements were successfully deleted';
$string['af_allitems_hided'] = 'All the elements were successfully hided';
$string['af_allitems_visible'] = 'All the elements were successfully made visible';
$string['af_chaindeleted'] = 'The \'{$a->pluginname}\' element: {$a->content} and descending element(s) have been successfully deleted';
$string['af_hiddenitems_deleted'] = 'All hidden elements were successfully deleted';
$string['af_itemdeleted'] = 'The \'{$a->pluginname}\' element: {$a->content} has been successfully deleted';
$string['af_multiland_dropped'] = 'Multilang for the loaded mastertemplate was dropped. Now elements are editable.';
$string['af_visibleitems_deleted'] = 'All visible elements were successfully deleted';
...
$string['askdeleteallresponses'] = 'Are you sure you want delete ALL saved responses?';
$string['askdeletemyresponse'] = 'Are you sure you want delete the response created on {$a->timecreated} and modified on {$a->timemodified}?';
$string['askdeletemyresponsenevermodified'] = 'Are you sure you want delete the response created on {$a->timecreated} and never modified?';
$string['askdeleteitem'] = 'Are you sure you want delete the \'{$a->pluginname}\' element: {$a->content}';
$string['askdeleteresponse'] = 'Are you sure you want delete the response owned by {$a->fullname}, created on {$a->timecreated} and modified on {$a->timemodified}?';
$string['askdeleteresponsenevermodified'] = 'Are you sure you want delete the response owned by {$a->fullname}, created on {$a->timecreated} and never modified?';
$string['askdeletetemplate'] = 'Are you sure you want delete the user template "{$a}"';
$string['askduplicateresponse'] = 'Are you sure you want duplicate the response owned by {$a->fullname}, created on {$a->timecreated} and modified on {$a->timemodified}?';
$string['askduplicateresponsenevermodified'] = 'Are you sure you want duplicate the response owned by {$a->fullname}, created on {$a->timecreated} and never modified?';
$string['askduplicatemyresponse'] = 'Are you sure you want duplicate the response created on {$a->timecreated} and modified on {$a->timemodified}?';
$string['askduplicatemyresponsenevermodified'] = 'Are you sure you want duplicate the response created on {$a->timecreated} and never modified?';
$string['askitemstoreserved'] = 'Switching to "Reserved" the element {$a->parentid}, all its dependencies will be switched to "Reserved" too.<br />Dependency(ies) is (are) the element(s) in position: {$a->dependencies}.<br />Do you confirm this action?';
$string['askitemtohide'] = 'Hiding the element {$a->parentid} its dependencies will be hided too.<br />Dependency is the element in position: {$a->dependencies}.<br />Do you confirm this action?';
$string['askitemstohide'] = 'Hiding the element {$a->parentid} all its dependencies will be hided too.<br />Dependencies are the elements in position: {$a->dependencies}.<br />Do you confirm this action?';
$string['askitemtoshow'] = 'Showing the element {$a->lastitem} you are going to show its ancestor.<br />Ancestor is the element in position: {$a->ancestors}.<br />Do you confirm this action?';
$string['askitemstoshow'] = 'Showing the element {$a->lastitem} you are going to show all its ancestors.<br />Ancestors are the elements in position: {$a->ancestors}.<br />Do you confirm this action?';
$string['askitemtostandard'] = 'Switching to "Standard" the element {$a->lastitem} you are going to switch to "Standard" its ancestor.<br />Ancestor is the element in position: {$a->ancestors}.<br />Do you confirm this action?';
$string['askitemstostandard'] = 'Switching to "Standard" the element {$a->lastitem} you are going to switch to "Standard" all its ancestors.<br />Ancestors are the elements in position: {$a->ancestors}.<br />Do you confirm this action?';
...
$string['confirm_deleteall'] = 'Do you confirm the deletion of all the elements?';
$string['confirm_deletehidden'] = 'Do you confirm the deletion of all the hidden elements?';
$string['confirm_deletevisible'] = 'Do you confirm the deletion of all the visible elements?';
$string['confirm_hideall'] = 'Do you confirm to make each element hidden?';
$string['confirm_showall'] = 'Do you confirm to make each element visible?';
...
$string['event_all_items_deleted'] = 'All items have been deleted';
$string['event_all_items_hidden'] = 'All items have been made hidden';
$string['event_all_items_visible'] = 'All items have been made visible';
...
$string['event_hidden_items_deleted'] = 'Hidden items have been deleted';
...
$string['event_visible_items_deleted'] = 'Visible items have been deleted';
...
$string['includereserved'] = 'Include reserved element';
...
$string['itemeditmakereserved'] = 'Marking this element as "Reserved", some depending elements were forced to "Reserved" too.';
...
$string['itemeditshowinbasicform'] = 'Removing the "Reserved" attribute from this element, some parent elements were forced to "Standard" element too.';
...
$string['responseduplicated'] = 'User response has been successfully duplicated';
