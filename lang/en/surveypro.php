...
$string['keepinprogress'] = 'Keep "in progress" submissions';
$string['keepinprogress_help'] = 'Do not delete "in progress" submissions in spite of module policy. "In progress" submissions are supposed to be dropped to always guarantee a good reliability to the final database of responses. If, for any reason, you need to collect also the "in progress" responses, check this box.';
$string['left'] = 'left';
