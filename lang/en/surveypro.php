...
$string['hassubmissions_alert'] = 'This survey has already been answered at least once.<br />Please proceed with extreme caution and make only neutral changes to not compromise the validity of the whole survey.<br /><br />BE WARNED: Altering an item and saving it again IMPLIES that the status of each already submitted response is changed to "in progress".<br />"In progress" responses are subject to deletion in 4 hours if save/resume is not allowed and are subject to deletion in the number of hours set into surveypro settings page if save/resume is allowed.';
