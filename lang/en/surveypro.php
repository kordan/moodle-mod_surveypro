...
// $string['tabsurveypro'] = 'Use';
    $string['tabsurveypro_dashboard'] = 'Dashboard'; // Maybe 'Overview' is better?
    $string['tabsurveypro_responses'] = 'Responses';
    $string['tabsurveypro_insert'] = 'Insert';
    $string['tabsurveypro_edit'] = 'Edit';
    $string['tabsurveypro_readonly'] = 'Read only';
    $string['tabsurveypro_search'] = 'Search';
$string['tablayout'] = 'Layout';
    $string['tablayout_preview'] = 'Preview';
    $string['tablayout_elements'] = 'Elements';
    $string['tablayout_elementsetup'] = 'Element setup';
    $string['tablayout_branchingvalidation'] = 'Branching validation';
$string['tabtools'] = 'Tools';
    $string['tabtools_import'] = 'Import';
    $string['tabtools_export'] = 'Export';
$string['tabpresets'] = 'Presets';
    // Userpresets.
    $string['tabupreset_manage'] = 'Manage';
    $string['tabupreset_save'] = 'Save';
    $string['tabupreset_import'] = 'Import';
    $string['tabupreset_apply'] = 'Apply';
    // Masterpresets.
    $string['tabmpreset_save'] = 'Save';
    $string['tabmpreset_apply'] = 'Apply';
