...
$string['askitemstoadvanced'] = 'Switching to "Advanced" the element {$a->parentid} all its dependencies will be switched to "Advanced" too.<br />Dependency(ies) is (are) the element(s) in position: {$a->dependencies}.<br />Do you confirm this action?';
