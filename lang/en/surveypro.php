...
$string['tabsubmissionsname'] = 'Survey';
    $string['tabsubmissionspage1'] = 'Control panel';
...
$string['hidden_help'] = 'Use this option to hide the element. Hided elements will not be available to anyone. You can consider these elements as not part of the surveypro.';
...
$string['mastertemplate_help'] = 'Choose the master template you want to add to your surveypro.';
$string['mastertemplate_noedit'] = 'Current survey supports multilanguage as imported from a master template.<br />This means that the survey displays questions and labels according to the user preferred language (if available).<br />By editing this kind of survey you will lose the multilanguage support returning to the standard indifferenciated labels all along the surveypro.<br />Be warned that once you drop the multilanguage support even by generating again a master template, you still no longer get missed languages and, last but not least, the drop of the multilanguage support is not undoable.<br />Are you sure you want to edit this multilanguage surveypro?';
...
$string['missingparentid_err'] = 'You need to select a element to branch the surveypro. Otherwise clear the "{$a}" field';
$string['module'] = 'This instance of surveypro';
$string['months'] = 'months';
$string['mtemplatessection'] = 'Master templates section';
$string['multilang'] = 'Restore multilang content';
$string['multilangdropped'] = 'Multilang content has been dropped for this surveypro';
...
$string['nosubmissionfound'] = 'No attempt were found for this surveypro. This report has no use.';
...
$string['surveypro:preview'] = 'Preview a surveypro';
...
$string['surveypro:view'] = 'View surveypros';
...
$string['system'] = 'Site';
$string['templatecreateinfo'] = 'Save a user template with the current surveypro. At any time you can download and share it with other moodle users or restore it to your own server. Be careful to "{$a}" if you want to reuse your templates without downloading and reloading them.';
...
$string['userstyle_help'] = 'Add here one or more cascade style sheet (css) you want to apply to this surveypro';
$string['userstyle'] = 'Custom style sheet';
$string['usertemplate_help'] = 'Choose the user template you want to add to your surveypro.';
...
$string['validationinfo'] = 'This tool let you verify the reliability of the current surveypro. This tool checks the validity of each relation identifying the bad ones that will never allow child element to be included in the surveypro.';
...
$string['wrondindexesinxml'] = 'Items in XML have are not rightly indexed';
