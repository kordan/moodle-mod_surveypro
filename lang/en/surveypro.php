...
$string['confirm_free1item'] = 'Switching to "Generally available" the element {$a->lastitem} you are going to make generally available its ancestor.<br />Ancestor is the element in position: {$a->ancestors}.<br />Do you confirm this action?';
$string['confirm_freechainitems'] = 'Switching to "Generally available" the element {$a->lastitem}, all its ancestors will be switched to "Generally available" too.<br />Ancestors are the elements in position: {$a->ancestors}.<br />Do you confirm this action?';
...
$string['insearchform'] = 'Searchable item. Click to make it not searchable.';
