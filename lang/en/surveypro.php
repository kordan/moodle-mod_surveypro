...
$string['confirm_hide1item'] = 'Hiding the element {$a->parentid} its dependency will be hided too.<br />Dependency is the element in position: {$a->dependencies}.<br />Do you confirm this action?';
$string['confirm_hideallitems'] = 'Do you confirm to hiding of ALL element?';
$string['confirm_hidechainitems'] = 'Hiding the element {$a->parentid} all its dependencies will be hided too.<br />Dependencies are the elements in position: {$a->dependencies}.<br />Do you confirm this action?';
...
$string['event_item_hided'] = 'An item has been hided';
$string['event_item_modified'] = 'An item has been modified';
$string['event_item_showed'] = 'An item has been showed';
...
$string['feedback_hideallitems'] = 'All the elements were successfully hided';
...
$string['feedback_itemediting_hidechainitems'] = 'Hiding this element, some depending elements were hided too.';
...
$string['feedback_itemediting_showchainitems'] = 'Showing this element, some ascending elements were showed too.';
$string['feedback_showallitems'] = 'All the elements were successfully made visible';
