...
$string['askdeleteresponsenevermodified'] = 'Are you sure you want delete the responses owned by {$a->fullname}, created on {$a->timecreated} and never modified?';
...
$string['askitemstohide'] = 'Hiding the element {$a->parentid} all its dependencies will be hided too.<br />Dependency(ies) is (are) the element(s) in position: {$a->dependencies}.<br />Do you confirm this action?';
$string['askitemstoshow'] = 'Showing the element {$a->lastitem} you are going to show all its ancestors.<br />Ancestor(s) is (are) the element(s) in position: {$a->ancestors}.<br />Do you confirm this action?';
$string['askitemstostandard'] = 'Switching to "Standard" the element {$a->lastitem} you are going to switch to "Standard" all its ancestors.<br />Ancestor(s) is (are) the element(s) in position: {$a->ancestors}.<br />Do you confirm this action?';
...
$string['submissions_all'] = '{$a->submissions} {$a->responses} submitted by {$a->usercount} {$a->users}';
$string['submissions_detail'] = '{$a->submissions} \'{$a->status}\' {$a->responses} submitted by {$a->usercount} {$a->users}';
