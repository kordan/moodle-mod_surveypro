...
$string['reserved'] = 'Reserved element';
...
$string['askitemstoreserved'] = 'Switching to "Advanced" the element {$a->parentid} all its dependencies will be switched to "Advanced" too.<br />Dependency(ies) is (are) the element(s) in position: {$a->dependencies}.<br />Do you confirm this action?';
...
$string['itemeditmakereserved'] = 'Marking this element as "Advanced", some depending elements were forced to "Advanced" too.';
