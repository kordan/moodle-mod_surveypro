...
$string['tabsubmissionsname'] = 'Survey';
    ...
    $string['tabsubmissionspage7'] = 'Reportess';
...
$string['bulkaction_help'] = 'Use este menú para realizar acciones contra eleentos como se describen por etiquetas.';
...
$string['confirm_delete1response'] = '¿Está Usted seguro de querer eliminar la respuesta perteneciente a {$a->fullname}, creada en {$a->timecreated} y modificada en {$a->timemodified}?';
...
$string['keepinprogress_help'] = 'No eliminar respuestas "ie progreso" aun a pesar de política del módulo. Las respuestas "En progreso" se suponía que fueran descartadas para garantizar siempre una buena confibilidad a la base de datos final. Si, por cualquier razón, Usted necesitara colectartambién las respuestas "en progreso" , active esta casilla.';
