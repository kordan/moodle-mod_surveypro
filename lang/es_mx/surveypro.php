...
$string['confirm_reservechainitems'] = 'Al reservar el elemento {$a->parentid}, todas las dependencias del elemento element "{$a->parentcontent}" serán reservadas también.<br />Así, además del elemento elegido, Usted va a reservar los elementos en posición: {$a->dependencies}.<br />D¿Confirma Usted esta acción?';
