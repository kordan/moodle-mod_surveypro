...
$string['answerlabel'] = 'etiqueta';
$string['answernotsubmitted'] = 'Contestación no enviada';
$string['answerposition'] = 'posición';
$string['answervalue'] = 'valor';
...
$string['available'] = 'Elemento de acceso libre. Haga click para reservar.';
...
$string['confirm_free1item'] = 'Liberando al elemento {$a->lastitem} Usted va a liberar a su ancestro.<br />Ancestro es el elemento en posición: {$a->ancestors}.<br />¿Confirma Usted esta acción?';
$string['confirm_freechainitems'] = 'Reservando al elemento {$a->lastitem} Usted va a reservar a todos sus ancestros.<br />Ancestros son los elementos en posición: {$a->ancestors}.<br />¿Confirma Usted esta acción?';
$string['confirm_hide1item'] = 'Ocultando al elementot {$a->parentid} su dependencia se ocultará también.<br />Dependencia es el elemento en posición: {$a->dependencies}.<br />¿Confirma Usted esta acción?';
$string['confirm_hideallitems'] = '¿Confirma Usted el ocultamiento de TODOS los elementos?';
$string['confirm_hidechainitems'] = 'Ocultando al elementot {$a->parentid} todas sus dependencias se ocultarán también.<br />Dependencias son los elementos en posición: {$a->dependencies}.<br />¿Confirma Usted esta acción?';
$string['confirm_reserve1item'] = 'Cambiando a "Reservado" el elemento {$a->parentid}, su dependencia se cambiará también a "Reservado".<br />Dependencia es el elemento en posición: {$a->dependencies}.<br />¿Confirma Usted esta acción?';
...
$string['forcedoptionalitem'] = 'Elemento opcional forzado debido al valor por defecto.';
...
$string['hidefield'] = 'Elemento visible. Hacer click para ocultar.';
...
$string['namenotset'] = 'no configurado';
$string['needrole'] = 'Elemento reservado. Haga click para liberarlo.';
...
$string['notifymore'] = 'Más notificaciones';
$string['notifymore_help'] = 'Algunas direcciones Email adicionales a notificar acerca de nuevas respuestas. Las direcciones son una por fila.';
$string['notifyrole'] = 'Rol a notificarle';
$string['notifyrole_help'] = 'Mandar un Email a cada componente de los roles seleccionaos en cada respuesta. El Email solamente avisará acerca de que hay respuestas del usuario, no sobre el contenido y sin detalles del remitente.';
$string['notsearchable'] = 'Ítem no buscable. Haga click para  hacerlo buscable.';
...
$string['optionalitem'] = 'Elemento opcional. Haga click para volver obligatorio al elemento.';
...
$string['parentelement'] = 'Elemento paterno';
...
$string['reportederrortemplate'] = '%s como se requiere por el xsd del plugin "%s"';
...
$string['requireditem'] = 'Elemento obligatorio. Haga click para hacer opcional al elemento.';
...
$string['searchable'] = 'Ítem buscable. Haga click para  hacerlo no buscable.';
...
$string['showfield'] = 'Elemento oculto. Haga click para mostrar.';
...
$string['thankshtml'] = 'Página web de agradecimiento';
$string['thankshtml_help'] = 'El código HTML de la página web que obtiene el usuario en cada hora de cierre de respuesta.';
...
$string['unavailableelement'] = 'Elemento no disponible. Des-ocúltelo para hacerlo disponible.';
$string['unhandledvalue'] = 'Valor no-manejado de retorno de {$a}';
$string['unixtime'] = 'hora Unix';
$string['unlimited'] = 'Ilimitados';
$string['unreservable'] = 'elemento de acceso libre.No-reservable.';
$string['unsearchable'] = 'Ítem no buscable. In-buscable';
$string['user'] = 'Usuario';
