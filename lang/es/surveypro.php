...
// $string['tabsurveypro'] = 'Use';
    $string['tabsurveypro_dashboard'] = 'Tablero'; // Maybe 'Overview' is better?
    $string['tabsurveypro_responses'] = 'Respuestas';
    $string['tabsurveypro_insert'] = 'Insertar';
    $string['tabsurveypro_edit'] = 'Editar';
    $string['tabsurveypro_readonly'] = 'Solo lectura';
    $string['tabsurveypro_search'] = 'Buscar';
$string['tablayout'] = 'Diseño';
    $string['tablayout_preview'] = 'Previsualización';
    $string['tablayout_elements'] = 'Elementos';
    $string['tablayout_elementsetup'] = 'Configuración de elemento';
    $string['tablayout_branchingvalidation'] = 'Validación ramificada';
$string['tabtools'] = 'Tools';
    $string['tabtools_import'] = 'Importar';
    $string['tabtools_export'] = 'Exportar';
$string['tabpresets'] = 'Plantillas';
    // Userpresets.
    $string['tabupreset_manage'] = 'Gestionar';
    $string['tabupreset_save'] = 'Guardar';
    $string['tabupreset_import'] = 'Importar';
    $string['tabupreset_apply'] = 'Aplicar';
    // Masterpresets.
    $string['tabmpreset_save'] = 'Guardar';
    $string['tabmpreset_apply'] = 'Aplicar';
$string['tabreports'] = 'Reportes';
