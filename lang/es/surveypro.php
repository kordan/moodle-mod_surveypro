...
$string['confirm_delete1ownresponse'] = '¿Está  seguro de querer eliminar la respuesta creada en {$a->timecreated} y modificada en {$a->timemodified}?';
$string['confirm_delete1ownresponse_nevmod'] = '¿Está seguro de querer eliminar la respuesta creada en {$a->timecreated} y nunca modificada?';
$string['confirm_delete1response'] = '¿Está  seguro de querer eliminar la respuesta perteneciente a {$a->fullname}, creada en {$a->timecreated} y modificada en {$a->timemodified}?';
$string['confirm_delete1response_nevmod'] = '¿Está seguro de querer eliminar la respuesta perteneciente a {$a->fullname}, creada en {$a->timecreated} y nunca modificada?';
...
$string['confirm_duplicate1foreignresponse_nevmod'] = '¿Está seguro de querer duplicar la respuesta peerteneciente a {$a->fullname}, creada en {$a->timecreated} y nunca modificada?';
$string['confirm_duplicate1foreignresponse'] = '¿Está  seguro de querer duplicar la respuesta peerteneciente a {$a->fullname}, creada en {$a->timecreated} y modificada en {$a->timemodified}?';
$string['confirm_duplicate1ownresponse'] = '¿Está seguro de querer duplicar la respuesta creada en {$a->timecreated} y modificada en {$a->timemodified}?';
$string['confirm_duplicate1ownresponse_nevmod'] = '¿Está seguro de querer duplicar la respuesta creada en {$a->timecreated} y nunca modificada?';
