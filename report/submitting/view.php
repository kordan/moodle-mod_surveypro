...
/**
 * Starting page of the submitting report.
 *
...
require_once($CFG->dirroot.'/mod/surveypro/report/submitting/classes/report.class.php');
...
// Output starts here.
$url = new moodle_url('/mod/surveypro/report/submitting/view.php', array('s' => $surveypro->id));
$PAGE->set_url($url);
...
$reportman = new mod_surveypro_report_submitting($cm, $context, $surveypro);
