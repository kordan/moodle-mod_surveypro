...
// Output starts here.
$url = new moodle_url('/mod/surveypro/report/responsesperuser/view.php', array('id' => $cm->id));
$PAGE->set_url($url);
...
echo $OUTPUT->header();
echo $OUTPUT->heading(format_string(get_string('pluginname', 'surveyproreport_responsesperuser')), 2, null);
