...
require_once($CFG->dirroot.'/mod/surveypro/report/attachments_overview/classes/report.class.php');
...
$reportman = new mod_surveypro_report_attachments_overview($cm, context_course::instance($COURSE->id), $surveypro);
