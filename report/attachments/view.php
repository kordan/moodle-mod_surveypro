...
// Output starts here.
$url = new moodle_url('/mod/surveypro/report/attachments/view.php', array('id' => $cm->id));
$PAGE->set_url($url);
...
echo $OUTPUT->header();
echo $OUTPUT->heading(format_string(get_string('pluginname', 'surveyproreport_attachments')), 2, null);
