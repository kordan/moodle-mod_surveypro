...
class backup_surveypro_activity_structure_step extends backup_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        $surveypro = new backup_nested_element('surveypro', array('id'), array(
                    ...
                    'maxentries', 'notifyrole', 'notifymore', 'notifycontent', 'notifycontentformat',
        ...
        $surveypro->annotate_files('mod_surveypro', 'mailcontent', null); // This file area does not have an itemid.
